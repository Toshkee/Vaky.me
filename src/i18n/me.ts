  ...
  work: {
    ...
    items: [
      ...
      },
      {
        ...
        solution: "Jelovnik kao tekst po kategorijama, poziv i rezervacija na jedan dodir.",
      ...
      },
      {
        ...
        tag: "Teretana",
        href: "/demo/titan-gym/",
        brief: "Članarine i raspored grupnih treninga stalno se traže preko poruka.",
        solution: "Cjenovnik i sedmični raspored na sajtu, probni trening kao glavno dugme.",
      ...
      },
      {
        ...
        solution: "Cjenovnik, radno vrijeme i tim na jednoj stranici, Viber na dohvat palca.",
