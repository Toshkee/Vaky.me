        ...
        <section>
          <div className="relative mx-auto grid max-w-6xl gap-y-9 px-5 pt-6 sm:px-8 sm:pt-10 lg:grid-cols-12 lg:items-center lg:gap-x-8 lg:pt-12">
            ...
            {/* Inset from the top of the mount so the carbon reads as a mount
                ...
                the portrait sits down onto the running foot. Only the tablet
                box is landscape, so it is the one width where the vertical crop
                does anything — 6% keeps the flower and the hairline in frame. */}
            <div className="relative lg:col-span-5 lg:col-start-8 lg:pt-14">
              <DemoPhoto
                src={portrait.src}
                alt={portrait.alt}
                ...
                priority
                sizes="(min-width: 1280px) 31vw, (min-width: 1024px) 38vw, 92vw"
        ...
        >
          <div className="mx-auto grid max-w-6xl gap-y-10 px-5 py-16 sm:px-8 sm:py-24 lg:grid-cols-12 lg:items-end lg:gap-x-8">
            <div className="lg:col-span-7">
              <h2 className={`${label} text-[var(--mila-rose-light)]`}>Edukacije</h2>
              <p
                className={`${serif} mt-6 text-[clamp(2rem,5vw,3.6rem)] font-medium leading-[1.02] tracking-[-0.02em]`}
              >
        ...
        <section id="shop" className="scroll-mt-6 bg-[var(--mila-rose-wash)]">
          ...
          <div className="mx-auto grid max-w-6xl gap-y-6 px-5 py-12 sm:px-8 sm:py-14 lg:grid-cols-12 lg:items-baseline lg:gap-x-8">
            <div className="lg:col-span-4">
              <h2 className={`${label} text-[var(--mila-rose-deep)]`}>Shop</h2>
              <p
                className={`${serif} mt-4 max-w-xs text-[clamp(1.5rem,2.8vw,2rem)] font-medium leading-[1.08] tracking-[-0.015em]`}
              >
